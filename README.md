# SolrTS
![Build status on Travis](https://travis-ci.org/h-sslefree/solrts.svg?branch=master) [![License: ISC](https://img.shields.io/badge/License-ISC-blue.svg)](https://opensource.org/licenses/ISC)
